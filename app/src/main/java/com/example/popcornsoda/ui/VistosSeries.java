...
public class VistosSeries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vistos_series);
        ...
        cursor_series_favoritas = helper.getSeriesVistas();
        ...
        //Lista Vertical
        ListView listViewSeries = findViewById(R.id.lista_series_vertical_vistos);
